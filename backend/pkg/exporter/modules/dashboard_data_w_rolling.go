		...
		WITH
			...
			aggregate_head as (
				SELECT 
					...
					{{ .Agg.SUM }}sync_reward{{ .Agg.AGG_END }} as sync_reward,
					...
					{{ .Agg.SUM }}attestations_observed{{ .Agg.AGG_END }} as attestations_observed,
					{{ .Agg.SUM }}attestations_head_executed{{ .Agg.AGG_END }} as attestations_head_executed,
					{{ .Agg.SUM }}attestations_source_executed{{ .Agg.AGG_END }} as attestations_source_executed,
					{{ .Agg.SUM }}attestations_target_executed{{ .Agg.AGG_END }} as attestations_target_executed,
			...
			SELECT
				...
				COALESCE(aggregate_head.sync_reward, 0) as ,
				...
				COALESCE(aggregate_head.attestations_observed, 0) as attestations_observed,
				COALESCE(aggregate_head.attestations_head_executed, 0) as attestations_head_executed,
				COALESCE(aggregate_head.attestations_source_executed, 0) as attestations_source_executed,
				COALESCE(aggregate_head.attestations_target_executed, 0) as attestations_target_executed,
			...
			ON CONFLICT {{ .TableConflict }} DO UPDATE SET
					...
					sync_reward = NULLIF(COALESCE({{ .TableTo }}.sync_reward, 0) + EXCLUDED.sync_reward, 0),
					...
					attestations_observed = NULLIF(COALESCE({{ .TableTo }}.attestations_observed, 0) + EXCLUDED.attestations_observed, 0),
					attestations_head_executed = NULLIF(COALESCE({{ .TableTo }}.attestations_head_executed, 0) + EXCLUDED.attestations_head_executed, 0),
					attestations_source_executed = NULLIF(COALESCE({{ .TableTo }}.attestations_source_executed, 0) + EXCLUDED.attestations_source_executed, 0),
					attestations_target_executed = NULLIF(COALESCE({{ .TableTo }}.attestation_target_executed, 0) + EXCLUDED.attestations_target_executed, 0),
		...
		WITH
			...
			result as (
				SELECT
					...
					COALESCE(aggregate_tail.sync_reward, 0) as sync_reward,
					balance_start,
					...
					COALESCE(aggregate_tail.attestations_observed, 0) as attestations_observed,
					COALESCE(aggregate_tail.attestations_head_executed, 0) as attestations_head_executed,
					COALESCE(aggregate_tail.attestations_source_executed, 0) as attestations_source_executed,
					COALESCE(aggregate_tail.attestations_target_executed, 0) as attestations_target_executed,
			...
			UPDATE %[1]s AS v SET
					...
					sync_reward = COALESCE(v.sync_reward, 0) - result.sync_reward,
					...
					attestations_observed = COALESCE(v.attestations_observed, 0) - result.attestations_observed,
					attestations_head_executed = COALESCE(v.attestations_head_executed, 0) - result.attestations_head_executed,
					attestations_source_executed = COALESCE(v.attestations_source_executed, 0) - result.attestations_source_executed,
					attestations_target_executed = COALESCE(v.attestations_target_executed, 0) - result.attestations_target_executed,
