...
type ConsolidationRejectedPreQueueEventTransformer struct{}

func (d *ConsolidationRejectedPreQueueEventTransformer) Transform(tx *sqlx.Tx, events []types.ConsensusLayerEvent) (int, error) {
