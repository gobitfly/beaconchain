...
type DepositRejectedPreQueueEventTransformer struct{}

func (d *DepositRejectedPreQueueEventTransformer) Transform(tx *sqlx.Tx, events []types.ConsensusLayerEvent) (int, error) {
