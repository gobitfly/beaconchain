...
func addValidatorDashboardRoutes(hs *handlers.HandlerService, publicRouter, internalRouter *mux.Router, cfg *types.Config) {
	...
	endpoints := []endpoint{
		...
		{http.MethodGet, "/{dashboard_id}/consensus-layer-withdrawals", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerWithdrawals, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerWithdrawals, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/total-execution-layer-withdrawals", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalExecutionLayerWithdrawals, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalExecutionLayerWithdrawals, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/total-consensus-layer-withdrawals", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalConsensusLayerWithdrawals, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalConsensusLayerWithdrawals, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/execution-layer-consolidations", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardExecutionLayerConsolidations, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardExecutionLayerConsolidations, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/consensus-layer-consolidations", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerConsolidations, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerConsolidations, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/execution-layer-deposits", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardExecutionLayerDeposits, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardExecutionLayerDeposits, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/consensus-layer-deposits", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerDeposits, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardConsensusLayerDeposits, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/total-execution-layer-deposits", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalExecutionLayerDeposits, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalExecutionLayerDeposits, allowMocking)},
		{http.MethodGet, "/{dashboard_id}/total-consensus-layer-deposits", handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalConsensusLayerDeposits, allowMocking), handlers.Handle(http.StatusOK, hs.GetValidatorDashboardTotalConsensusLayerDeposits, allowMocking)},
