...
func addRoutes(hs *handlers.HandlerService, publicRouter, internalRouter *mux.Router, cfg *types.Config) {
	...
	endpoints := []endpoint{
		...
		{http.MethodGet, "/networks/{network}/blocks/{block}", hs.PublicGetNetworkBlock, hs.InternalGetBlock},
		{http.MethodGet, "/networks/{network}/blocks/{block}/overview", hs.PublicGetNetworkBlock, hs.InternalGetBlockOverview},
		{http.MethodGet, "/networks/{network}/blocks/{block}/transactions", hs.PublicGetNetworkBlock, hs.InternalGetBlockTransactions},
		{http.MethodGet, "/networks/{network}/blocks/{block}/votes", hs.PublicGetNetworkBlock, hs.InternalGetBlockVotes},
		{http.MethodGet, "/networks/{network}/blocks/{block}/attestations", hs.PublicGetNetworkBlock, hs.InternalGetBlockAttestations},
		{http.MethodGet, "/networks/{network}/blocks/{block}/withdrawals", hs.PublicGetNetworkBlock, hs.InternalGetBlockWithdrawals},
		{http.MethodGet, "/networks/{network}/blocks/{block}/bls-change", hs.PublicGetNetworkBlock, hs.InternalGetBlockBlsChange},
		{http.MethodGet, "/networks/{network}/blocks/{block}/voluntary-exits", hs.PublicGetNetworkBlock, hs.InternalGetBlockVoluntaryExits},
		{http.MethodGet, "/networks/{network}/blocks/{block}/blobs", hs.PublicGetNetworkBlock, hs.InternalGetBlockBlobs},
