...
type ValidatorDashboard struct {
	...
	EffectiveBalance decimal.Decimal `json:"effective_balance" extensions:"x-order=7"`
	ValidatorCount   uint64          `json:"validator_count" extensions:"x-order=8"`
	GroupCount       uint64          `json:"group_count" extensions:"x-order=9"`
}
