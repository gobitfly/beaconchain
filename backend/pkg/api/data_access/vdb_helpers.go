...
type ValidatorDashboardRepository interface {
	...
	GetValidatorDashboardOverview(ctx context.Context, dashboardId t.VDBId, protocolModes []enums.ProtocolMode) (*t.VDBOverviewData, error)
	...
	GetValidatorDashboardSummary(ctx context.Context, dashboardId t.VDBId, period enums.TimePeriod, cursor string, colSort t.Sort[enums.VDBSummaryColumn], search string, limit uint64, protocolModes []enums.ProtocolMode) ([]t.VDBSummaryTableRow, *t.Paging, error)
	GetValidatorDashboardGroupSummary(ctx context.Context, dashboardId t.VDBId, groupId int64, period enums.TimePeriod, protocolModes []enums.ProtocolMode) (*t.VDBGroupSummaryData, error)
	...
	GetValidatorDashboardRewards(ctx context.Context, dashboardId t.VDBId, cursor string, colSort t.Sort[enums.VDBRewardsColumn], search string, limit uint64, protocolModes []enums.ProtocolMode) ([]t.VDBRewardsTableRow, *t.Paging, error)
	GetValidatorDashboardGroupRewards(ctx context.Context, dashboardId t.VDBId, groupId int64, epoch uint64, protocolModes []enums.ProtocolMode) (*t.VDBGroupRewardsData, error)
	GetValidatorDashboardRewardsChart(ctx context.Context, dashboardId t.VDBId, protocolModes []enums.ProtocolMode) (*t.ChartData[int, decimal.Decimal], error)

	GetValidatorDashboardDuties(ctx context.Context, dashboardId t.VDBId, epoch uint64, groupId int64, cursor string, colSort t.Sort[enums.VDBDutiesColumn], search string, limit uint64, protocolModes []enums.ProtocolMode) ([]t.VDBEpochDutiesTableRow, *t.Paging, error)

	GetValidatorDashboardBlocks(ctx context.Context, dashboardId t.VDBId, cursor string, colSort t.Sort[enums.VDBBlocksColumn], search string, limit uint64, protocolModes []enums.ProtocolMode) ([]t.VDBBlocksTableRow, *t.Paging, error)

	GetValidatorDashboardEpochHeatmap(ctx context.Context, dashboardId t.VDBId, protocolModes []enums.ProtocolMode) (*t.VDBHeatmap, error)
	GetValidatorDashboardDailyHeatmap(ctx context.Context, dashboardId t.VDBId, period enums.TimePeriod, protocolModes []enums.ProtocolMode) (*t.VDBHeatmap, error)
	GetValidatorDashboardGroupEpochHeatmap(ctx context.Context, dashboardId t.VDBId, groupId uint64, epoch uint64, protocolModes []enums.ProtocolMode) (*t.VDBHeatmapTooltipData, error)
	GetValidatorDashboardGroupDailyHeatmap(ctx context.Context, dashboardId t.VDBId, groupId uint64, date time.Time, protocolModes []enums.ProtocolMode) (*t.VDBHeatmapTooltipData, error)
	...
	GetValidatorDashboardWithdrawals(ctx context.Context, dashboardId t.VDBId, cursor string, colSort t.Sort[enums.VDBWithdrawalsColumn], search string, limit uint64, protocolModes []enums.ProtocolMode) ([]t.VDBWithdrawalsTableRow, *t.Paging, error)
	GetValidatorDashboardTotalWithdrawals(ctx context.Context, dashboardId t.VDBId, search string, protocolModes []enums.ProtocolMode) (*t.VDBTotalWithdrawalsData, error)
}
