...
func (d *DataAccessService) GetLatestExportedChartTs(ctx context.Context, aggregation enums.ChartAggregation) (uint64, error) {
	...
	switch aggregation {
	case enums.IntervalEpoch:
		table = "validator_dashboard_data_epoch_max_ts"
		dateColumn = "t"
	case enums.IntervalHourly:
		table = "validator_dashboard_data_hourly_max_ts"
		dateColumn = "t"
	case enums.IntervalDaily:
		table = "validator_dashboard_data_daily_max_ts"
		dateColumn = "t"
	case enums.IntervalWeekly:
		table = "validator_dashboard_data_weekly_max_ts"
		dateColumn = "t"
	default:
