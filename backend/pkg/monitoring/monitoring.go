...
func Stop() {
	...
	services.NewStatusReport(constants.Event_MonitoringCleanShutdown, constants.Default, constants.Default, utils.Config.DeploymentType)(constants.Success, nil)
