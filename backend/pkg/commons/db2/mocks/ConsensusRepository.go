...
// GetConsensusLayerEventsForFilters provides a mock function with given fields: filters
func (_m *ConsensusRepository) GetConsensusLayerEventsForFilters(filters []types.ConsensusLayerEventFilter) ([]types.ConsensusLayerEvent, error) {
	ret := _m.Called(filters)

	if len(ret) == 0 {
		panic("no return value specified for GetConsensusLayerEventsForFilters")
	}

	var r0 []types.ConsensusLayerEvent
	var r1 error
	if rf, ok := ret.Get(0).(func([]types.ConsensusLayerEventFilter) ([]types.ConsensusLayerEvent, error)); ok {
		return rf(filters)
	}
	if rf, ok := ret.Get(0).(func([]types.ConsensusLayerEventFilter) []types.ConsensusLayerEvent); ok {
		r0 = rf(filters)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]types.ConsensusLayerEvent)
		}
	}

	if rf, ok := ret.Get(1).(func([]types.ConsensusLayerEventFilter) error); ok {
		r1 = rf(filters)
	} else {
		r1 = ret.Error(1)
	}
...
// GetConsensusLayerEventsOfType provides a mock function with given fields: slot, eventName
func (_m *ConsensusRepository) GetConsensusLayerEventsOfType(slot uint64, eventName types.ConsensusLayerEventName) ([]types.ConsensusLayerEvent, error) {
	ret := _m.Called(slot, eventName)

	if len(ret) == 0 {
		panic("no return value specified for GetConsensusLayerEventsOfType")
	}

	var r0 []types.ConsensusLayerEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64, types.ConsensusLayerEventName) ([]types.ConsensusLayerEvent, error)); ok {
		return rf(slot, eventName)
	}
	if rf, ok := ret.Get(0).(func(uint64, types.ConsensusLayerEventName) []types.ConsensusLayerEvent); ok {
		r0 = rf(slot, eventName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]types.ConsensusLayerEvent)
		}
	...
	if rf, ok := ret.Get(1).(func(uint64, types.ConsensusLayerEventName) error); ok {
		r1 = rf(slot, eventName)
	} else {
		r1 = ret.Error(1)
	}
...
// GetLastIndexedConsensusLayerEventsEpoch provides a mock function with no fields
func (_m *ConsensusRepository) GetLastIndexedConsensusLayerEventsEpoch() (int64, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetLastIndexedConsensusLayerEventsEpoch")
	}
...
// GetWriterTx provides a mock function with no fields
func (_m *ConsensusRepository) GetWriterTx() (*sqlx.Tx, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWriterTx")
	}
...
// SavePendingDepositsQueue provides a mock function with given fields: pendingDeposits
func (_m *ConsensusRepository) SavePendingDepositsQueue(pendingDeposits []types.PendingDeposit) error {
	ret := _m.Called(pendingDeposits)

	if len(ret) == 0 {
		panic("no return value specified for SavePendingDepositsQueue")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func([]types.PendingDeposit) error); ok {
		r0 = rf(pendingDeposits)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateConsensusLayerExporterMetadata provides a mock function with given fields: _a0, _a1
func (_m *ConsensusRepository) UpdateConsensusLayerExporterMetadata(_a0 *sqlx.Tx, _a1 []types.EpochBlockRoots) error {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for UpdateConsensusLayerExporterMetadata")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*sqlx.Tx, []types.EpochBlockRoots) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
