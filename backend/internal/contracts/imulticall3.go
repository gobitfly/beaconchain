...
func (_IMulticall3 *IMulticall3Caller) Aggregate3(opts *bind.CallOpts, calls []IMulticall3Call3) ([]IMulticall3Result, error) {
	var out []interface{}
	err := _IMulticall3.contract.Call(opts, &out, "aggregate3", calls)
...
//
// Solidity: function aggregate3((address,bool,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3Session) Aggregate3(calls []IMulticall3Call3) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.Aggregate3(&_IMulticall3.CallOpts, calls)
}

// Aggregate3 is a free data retrieval call binding the contract method 0x82ad56cb.
//
// Solidity: function aggregate3((address,bool,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3CallerSession) Aggregate3(calls []IMulticall3Call3) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.Aggregate3(&_IMulticall3.CallOpts, calls)
}
...
func (_IMulticall3 *IMulticall3Caller) Aggregate3Value(opts *bind.CallOpts, calls []IMulticall3Call3Value) ([]IMulticall3Result, error) {
	var out []interface{}
	err := _IMulticall3.contract.Call(opts, &out, "aggregate3Value", calls)
...
//
// Solidity: function aggregate3Value((address,bool,uint256,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3Session) Aggregate3Value(calls []IMulticall3Call3Value) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.Aggregate3Value(&_IMulticall3.CallOpts, calls)
}

// Aggregate3Value is a free data retrieval call binding the contract method 0x174dea71.
//
// Solidity: function aggregate3Value((address,bool,uint256,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3CallerSession) Aggregate3Value(calls []IMulticall3Call3Value) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.Aggregate3Value(&_IMulticall3.CallOpts, calls)
}
...
func (_IMulticall3 *IMulticall3Caller) BlockAndAggregate(opts *bind.CallOpts, calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
	var out []interface{}
	err := _IMulticall3.contract.Call(opts, &out, "blockAndAggregate", calls)
...
//
// Solidity: function blockAndAggregate((address,bytes)[] calls) view returns(uint256 blockNumber, bytes32 blockHash, (bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3Session) BlockAndAggregate(calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
	return _IMulticall3.Contract.BlockAndAggregate(&_IMulticall3.CallOpts, calls)
}

// BlockAndAggregate is a free data retrieval call binding the contract method 0xc3077fa9.
//
// Solidity: function blockAndAggregate((address,bytes)[] calls) view returns(uint256 blockNumber, bytes32 blockHash, (bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3CallerSession) BlockAndAggregate(calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
...
func (_IMulticall3 *IMulticall3Caller) TryAggregate(opts *bind.CallOpts, requireSuccess bool, calls []IMulticall3Call) ([]IMulticall3Result, error) {
	var out []interface{}
	err := _IMulticall3.contract.Call(opts, &out, "tryAggregate", requireSuccess, calls)
...
//
// Solidity: function tryAggregate(bool requireSuccess, (address,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3Session) TryAggregate(requireSuccess bool, calls []IMulticall3Call) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.TryAggregate(&_IMulticall3.CallOpts, requireSuccess, calls)
}

// TryAggregate is a free data retrieval call binding the contract method 0xbce38bd7.
//
// Solidity: function tryAggregate(bool requireSuccess, (address,bytes)[] calls) view returns((bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3CallerSession) TryAggregate(requireSuccess bool, calls []IMulticall3Call) ([]IMulticall3Result, error) {
	return _IMulticall3.Contract.TryAggregate(&_IMulticall3.CallOpts, requireSuccess, calls)
}
...
func (_IMulticall3 *IMulticall3Caller) TryBlockAndAggregate(opts *bind.CallOpts, requireSuccess bool, calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
	var out []interface{}
	err := _IMulticall3.contract.Call(opts, &out, "tryBlockAndAggregate", requireSuccess, calls)
...
//
// Solidity: function tryBlockAndAggregate(bool requireSuccess, (address,bytes)[] calls) view returns(uint256 blockNumber, bytes32 blockHash, (bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3Session) TryBlockAndAggregate(requireSuccess bool, calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
	return _IMulticall3.Contract.TryBlockAndAggregate(&_IMulticall3.CallOpts, requireSuccess, calls)
}

// TryBlockAndAggregate is a free data retrieval call binding the contract method 0x399542e9.
//
// Solidity: function tryBlockAndAggregate(bool requireSuccess, (address,bytes)[] calls) view returns(uint256 blockNumber, bytes32 blockHash, (bool,bytes)[] returnData)
func (_IMulticall3 *IMulticall3CallerSession) TryBlockAndAggregate(requireSuccess bool, calls []IMulticall3Call) (struct {
	BlockNumber *big.Int
	BlockHash   [32]byte
	ReturnData  []IMulticall3Result
}, error) {
