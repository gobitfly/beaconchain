...
type ValidatorDashboardRepository interface {
	...
	GetValidatorDashboardSummaryChart(dashboardId t.VDBId, groupIds []uint64, efficiencyType enums.VDBSummaryChartEfficiencyType) (*t.ChartData[int, float64], error)
