...
type ValidatorDashboardRepository interface {
	...
	GetValidatorDashboardSummaryChart(dashboardId t.VDBId, groupIds []uint64, efficiencyType enums.VDBSummaryChartEfficiencyType, aggregation enums.ChartAggregation, afterTs uint64, beforeTs uint64) (*t.ChartData[int, float64], error)
