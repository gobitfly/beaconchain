...
SELECT 'up SQL query';
SELECT 'create dashboard_notifications_history table';
CREATE TABLE IF NOT EXISTS users_val_dashboards_notifications_history (
...
/* On the users db */
SELECT 'create machine_notifications_history table';
CREATE TABLE IF NOT EXISTS machine_notifications_history (
	user_id INT NOT NULL,
    epoch INT NOT NULL,
...
/* On the users db */
SELECT 'create client_notifications_history table';
CREATE TABLE IF NOT EXISTS client_notifications_history (
	user_id INT NOT NULL,
    epoch INT NOT NULL,
...
/* On the users db */
SELECT 'create network_notifications_history table';
CREATE TABLE IF NOT EXISTS network_notifications_history (
	user_id INT NOT NULL,
    epoch INT NOT NULL,
...
DROP TABLE IF EXISTS vdb_notifications_history;
