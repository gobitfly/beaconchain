...
/* eslint-disable */
import type { PeriodicValues, ClElValue, ApiDataResponse, StatusCount, ApiPagingResponse, Luck, ChartData, ValidatorHistoryDuties, Address, PubKey, Hash } from './common'
