...
export type InternalGetValidatorDashboardSummaryChartResponse = ApiDataResponse<HighchartsSeries[]>;
/**
 * ------------------------------------------------------------
 * Rewards Tab
 */
...
export type InternalGetValidatorDashboardRewardsChartResponse = ApiDataResponse<HighchartsSeries[]>;
/**
 * Duties Modal
 */
