...
func FormatBeaconscore(score float64, includeIcon bool) template.HTML {
	score = score * 100
	tooltipText := ""
	tooltipAdditionalText := "<br /><br />Read more about how we calculate the BeaconScore<sup>®</sup> in our <a href='https://kb.beaconcha.in/v2beta/metric-validator-efficiency' target='_blank'>docs</a>."
	if score < 0 {
		...
		tooltipText = "A BeaconScore<sup>®</sup> of 99.5% or higher is exceptional."
		...
		tooltipText = "A BeaconScore<sup>®</sup> between 99.0% and 99.5% is excellent."
		...
		tooltipText = "A BeaconScore<sup>®</sup> between 98.0% and 99.0% is fair."
		...
		tooltipText = "A BeaconScore<sup>®</sup> below 98.0% is bad."
