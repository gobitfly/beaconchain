...
<template>
  <IconDatatypeTokenIcon v-if="subCategory === SubCategory.Tokens" />
  <IconDatatypeNftIcon v-else-if="subCategory === SubCategory.NFTs" />
  <IconDatatypeEpochIcon v-else-if="subCategory === SubCategory.Epochs" />
  <IconDatatypeBlockIcon
    v-else-if="subCategory === SubCategory.SlotsAndBlocks"
  />
  <IconDatatypeTransactionIcon
    v-else-if="subCategory === SubCategory.Transactions"
  />
  ...
  <IconDatatypeValidatorIcon
    v-else-if="subCategory === SubCategory.Validators"
  />
</template>
