        ...
        >
          ...
          >
            ...
            <template #body="slotProps">
              <BcTableDateTime :unix-timestamp="slotProps.data.slot_processed" />
            </template>
          </Column>
          <Column
            v-if="!isMobile"
              ...
              <div class="dashboard-table-cl-consolidations__details-grid">
                <div class="dashboard-table-cl-consolidations__details-row">
                  <div class="dashboard-table-cl-consolidations__details-label">
                    {{ $t("dashboard.validator.cl_consolidations.slot_queued") }}
                  </div>
                  <BcLink
                ...
                >
                  <div class="dashboard-table-cl-consolidations__details-label">
                    {{ $t("dashboard.validator.cl_consolidations.slot_processed") }}
                  </div>
