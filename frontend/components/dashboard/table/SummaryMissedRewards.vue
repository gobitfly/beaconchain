...
<template>
  <div v-if="total && !total.isZero()" class="summary-reward">
    <BcFormatValue :value="total" :no-tooltip="true" />
      ...
      <template #tooltip>
        <div>
          ...
          <div class="tt-row">
            ...
            <BcFormatValue :value="missedRewards?.proposer_rewards.el" :no-tooltip="true" :full-value="true" />
          </div>
          <div class="tt-row">
            <span class="bold">{{ $t('dashboard.validator.blocks.cl_rewards') }}: </span>
            <BcFormatValue :value="missedRewards?.proposer_rewards.cl" :no-tooltip="true" :full-value="true" />
          </div>
          <div class="tt-row">
            <span class="bold">{{ $t('dashboard.validator.summary.row.attestations') }}: </span>
            <BcFormatValue :value="missedRewards?.attestations" :no-tooltip="true" :full-value="true" />
          </div>
          <div class="tt-row">
            <span class="bold">{{ $t('dashboard.validator.summary.row.sync_committee') }}: </span>
            <BcFormatValue :value="missedRewards?.sync" :no-tooltip="true" :full-value="true" />
          </div>
        </div>
      </template>
    </BcTooltip>
