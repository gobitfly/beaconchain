        ...
        >
          ...
          >
            ...
            <template #body="slotProps">
              <BcTableDateTime :unix-timestamp="slotProps.data.block_processed" />
            </template>
          </Column>
          <Column
            v-if="!isMobile"
          ...
          <Column
            v-if="isMobile"
            field="block_processed"
            :header="$t('dashboard.validator.el_consolidations.block_processed')"
          >
            <template #body="slotProps">
              <BcLink
          ...
          <template #expansion="slotProps">
            <div class="dashboard-table-el-consolidations__details">
              <div class="dashboard-table-el-consolidations__details-grid">
                ...
                <div class="dashboard-table-el-consolidations__details-row">
                  <div class="dashboard-table-el-consolidations__details-label">
                    {{ $t("dashboard.validator.el_consolidations.block_queued") }}
                  </div>
                  <BcLink
                ...
                >
                  <div class="dashboard-table-el-consolidations__details-label">
                    {{ $t("dashboard.validator.el_consolidations.block_processed") }}
                  </div>
