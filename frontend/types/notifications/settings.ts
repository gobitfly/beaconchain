...
export type NotificationsManagementSettingsGeneralTab = Pick<NotificationSettingsGeneral, 'do_not_disturb_timestamp' | 'is_email_notifications_enabled' | 'is_push_notifications_enabled'>
