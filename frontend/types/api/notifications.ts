...
/* eslint-disable */
import type { ApiDataResponse, ApiPagingResponse, IndexBlocks, IndexEpoch, Address, Hash } from './common'
...
export interface NotificationValidatorDashboardDetail {
  ...
  group_offline_reminder: NotificationEventGroup[]; // TODO not filled yet
